...
For starters, we need to download and install GIMP. You can download it from [here](https://www.gimp.org/downloads/). The current version (that I used for this tutorial) is 2.10.22 (revision 3). If you're on Mac, you can open (mount) that downloaded file and click and drag GIMP to the Applications folder. If you're on another OS, follow the instructions GIMP gives you :)
...
## Creating symbolic link to "fake" having `libintl.9`
